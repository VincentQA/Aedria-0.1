...
def generate_plan_and_pass_to_writer(user_input):
    ...
    # Après avoir récupéré le plan, envoyer ce plan à l'écrivain
    send_message_and_stream(ASSISTANT_ID_ECRIVAIN, "ecrivain", f"Voici le plan : {scenariste_plan}. Assure-toi de la cohérence entre la transition du choix du lecteur et du plan en cours.")
