...
if st.button('Répondre au questionnaire', key='questionnaire_button', help='Cliquez pour accéder au questionnaire'):
    js = "window.open('https://forms.gle/4FiNG71ZP7bWFcV4A')"
