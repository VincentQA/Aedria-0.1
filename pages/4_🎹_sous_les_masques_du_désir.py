...
def start_story():
    ...
    scenariste_plan = send_message_and_stream(ASSISTANT_ID_SCENARISTE_MDD_MDD, "scenariste", user_input)
...
def generate_plan_and_pass_to_writer(user_input):
    ...
    scenariste_plan = send_message_and_stream(ASSISTANT_ID_SCENARISTE_MDD_MDD, "scenariste", scenariste_prompt)
    # Après avoir récupéré le plan, envoyer ce plan à l'écrivain
